...
@section('links')
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/dropzone/dropzone.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-1to10.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-horizontal.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-movie.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-pill.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-reversed.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bars-square.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/bootstrap-stars.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/css-stars.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/examples.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/fontawesome-stars-o.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-bar-rating/fontawesome-stars.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-asColorPicker/css/asColorPicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/x-editable/bootstrap-editable.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/dropify/dropify.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-file-upload/uploadfile.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-tags-input/jquery.tagsinput.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.min.css') }}">
@endsection

@section('content')
    @adminPageHeader(['title' => 'Advanced elements', 'item' => 'Forms'])
    @endadminPageHeader
...
@section('scripts')
    ...
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-asColor/jquery-asColor.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-asGradient/jquery-asGradient.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-asColorPicker/jquery-asColorPicker.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/x-editable/bootstrap-editable.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/moment/moment.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/dropify/dropify.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-file-upload/jquery.uploadfile.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-tags-input/jquery.tagsinput.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/dropzone/dropzone.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery.repeater/jquery.repeater.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/inputmask/jquery.inputmask.bundle.js') }}"></script>

    <script src="{{ asset('vendor/purple-admin-pro/assets/js/formpickers.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/form-addons.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/x-editable.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/dropify.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/dropzone.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/jquery-file-upload.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/formpickers.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/form-repeater.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/inputmask.js') }}"></script>
@endsection
