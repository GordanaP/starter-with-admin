...
@section('content')
    @adminPageHeader(['title' => 'Validation', 'item' => 'Forms'])
    @endadminPageHeader
...
@section('scripts')
    ...
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/form-validation.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/bt-maxLength.js') }}"></script>
@endsection
