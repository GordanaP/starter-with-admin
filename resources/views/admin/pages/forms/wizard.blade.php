...
@section('content')
    @adminPageHeader(['title' => 'Wizard', 'item' => 'Forms'])
    @endadminPageHeader
                            ...
                            <section>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="checkbox" type="checkbox"> I agree with the Terms and Conditions.
                                    </label>
                                </div>
                            </section>
                        </div>
...
@section('scripts')
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-steps/jquery.steps.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/wizard.js') }}"></script>
@endsection
