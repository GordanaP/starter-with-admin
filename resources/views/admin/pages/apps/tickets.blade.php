                ...
                <div class="card-body">
                    ...
                    <div class="nav-scroller">
                        <ul class="nav nav-tabs tickets-tab-switch" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link rounded active" id="open-tab" data-toggle="tab" href="#open-tickets" role="tab" aria-controls="open-tickets" aria-selected="true">
                                    Open Tickets <div class="badge">13</div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded" id="pending-tab" data-toggle="tab" href="#pending-tickets" role="tab" aria-controls="pending-tickets" aria-selected="false">
                                    Pending Tickets <div class="badge">50 </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded" id="onhold-tab" data-toggle="tab" href="#onhold-tickets" role="tab" aria-controls="onhold-tickets" aria-selected="false">
                                    On-hold Tickets <div class="badge">29 </div>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-pane fade show active" id="open-tickets" role="tabpanel" aria-labelledby="open-tickets">
                            ...
                            <a href="#" class="tickets-card row">
                                <div class="tickets-details col-lg-8 col-12">
                                    ...
                                    <div class="wrapper text-muted d-none d-md-block">
                                        ...
                                        <img class="assignee-avatar" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face13.jpg') }}" alt="profile image">
                                ...
                                <div class="ticket-float col-lg-2 col-sm-6 d-none d-md-block">
                                    <img class="img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face16.jpg') }}" alt="profile image">
                            ...
                            <a href="#" class="tickets-card row">
                                <div class="tickets-details col-lg-8 col-12">
                                    ...
                                    <div class="wrapper text-muted d-none d-lg-block">
                                        <span>Assigned to</span>
                                        <img class="assignee-avatar" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face18.jpg') }}" alt="profile image">
                                        <span>Olivia Cross</span>
                                        <span><i class="mdi mdi-clock-outline"></i>04:23AM</span>
                                    </div>
                                </div>
                                <div class="ticket-float col-lg-2 col-12">
                                    <img class="img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face14.jpg') }}" alt="profile image">
                                    <span class="text-muted">Frank Briggs</span>
                                </div>
                            ...
                            <a href="#" class="tickets-card row">
                                <div class="tickets-details col-lg-8">
                                    ...
                                    <div class="wrapper text-muted d-none d-md-block">
                                          <span>Assigned to</span>
                                          <img class="assignee-avatar" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face11.jpg') }}" alt="profile image">
                                          <span>Leah Frank</span>
                                          <span><i class="mdi mdi-clock-outline"></i>04:24AM</span>
                                    </div>
                                </div>
                                <div class="ticket-float col-lg-2 col-sm-6">
                                    <img class="img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face10.jpg') }}" alt="profile image">
                            ...
                            <a href="#" class="tickets-card row">
                                ...
                                <div class="ticket-float col-lg-2 col-sm-6">
                                    <img class="img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face6.jpg') }}" alt="profile image">
                            ...
                            <a href="#" class="tickets-card row">
                                <div class="tickets-details col-lg-8">
                                    ...
                                    <div class="wrapper text-muted d-none d-md-block">
                                        <span>Assigned to</span>
                                        <img class="assignee-avatar" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face15.jpg') }}" alt="profile image">
                            ...
                            <a href="#" class="tickets-card row">
                                <div class="tickets-details col-lg-8">
                                    ...
                                    <div class="wrapper text-muted d-none d-md-block">
                                        <span>Assigned to</span>
                                        <img class="assignee-avatar" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face17.jpg') }}" alt="profile image">
                                        <span>Alta Little</span>
                                        <span><i class="mdi mdi-clock-outline"></i>06:16PM</span>
                                    </div>
                                </div>
                                <div class="ticket-float col-lg-2 col-sm-6">
                                    <img class="img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face20.jpg') }}" alt="profile image">
