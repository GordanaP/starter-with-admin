              ...
              <div class="menu-bar">
                    <ul class="menu-items">
                        <li class="compose mb-3">
                            <button class="btn bg-gradient-primary btn-block">Compose</button>
                        </li>
                        <li class="active">
                            <a href="#"><i class="mdi mdi-email-outline"></i> Inbox</a><span class="badge badge-pill badge-success">8</span>
                        </li>
                        <li>
                            <a href="#"><i class="mdi mdi-share"></i> Sent</a>
                        </li>
                        <li>
                            <a href="#"><i class="mdi mdi-file-outline"></i> Draft</a><span class="badge badge-pill badge-warning">4</span>
                        </li>
                        <li>
                            <a href="#"><i class="mdi mdi-upload"></i> Outbox</a><span class="badge badge-pill badge-danger">3</span>
                        </li>
                        <li>
                            <a href="#"><i class="mdi mdi-star-outline"></i> Starred</a>
                        </li>
                        <li>
                            <a href="#"><i class="mdi mdi-delete"></i> Trash</a>
                        </li>
                    </ul>
                    <div class="wrapper">
                    ...
                    <ul class="profile-list">
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face1.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face2.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face20.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face12.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face25.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face10.jpg') }}" alt=""></span>
                                <div class="user">
                      ...
                      <li class="profile-list-item"> <a href="#"> <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face23.jpg') }}" alt=""></span>
                          <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face11.jpg') }}" alt=""></span>
                                <div class="user">
                        ...
                        <li class="profile-list-item">
                            <a href="#">
                                <span class="pro-pic"><img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face9.jpg') }}" alt=""></span>
                                <div class="user">
            ...
            <div class="mail-view d-none d-md-block col-md-9 col-lg-7 bg-white">
                ...
                <div class="message-body">
                    <div class="sender-details">
                        <img class="img-sm rounded-circle mr-3" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face11.jpg') }}" alt="">
                        <div class="details">
