            ...
            <div class="d-flex flex-column flex-md-row align-items-center">
                ...
                <div class="wrapper d-flex align-items-center">
                    <div class="image-grouped ml-md-4">
                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face20.jpg') }}"
                        alt="profile image">
                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face17.jpg') }}"
                        alt="profile image">
                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face14.jpg') }}"
                        alt="profile image">
                    </div>
            ...
            <div class="board-wrapper pt-5">
                <div class="board-portlet">
                    ...
                    <ul id="portlet-card-list-1" class="portlet-card-list">
                        ...
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="task-date">20 Feb 2019</p>
                            <div class="action-dropdown dropdown">
                        ...
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-danger" role="progressbar" style="width: 32%" aria-valuenow="32" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 54%" aria-valuenow="54" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                ...
                <div class="board-portlet">
                    ...
                    <ul id="portlet-card-list-2" class="portlet-card-list">
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 24%" aria-valuenow="24" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="task-date">20 Feb 2019</p>
                            <div class="action-dropdown dropdown">
                            ...
                            <div class="image-grouped">
                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face12.jpg') }}"
                                alt="profile image">
                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face1.jpg') }}"
                                alt="profile image">
                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face6.jpg') }}"
                                alt="profile image">
                            </div>
                            <div class="badge badge-inverse-success">important</div>
                            <p class="due-date">Due 10 days</p>
                ...
                <div class="board-portlet">
                    ...
                    <ul id="portlet-card-list-3" class="portlet-card-list">
                        <li class="portlet-card">
                            <div class="progress">
                                <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="task-date">20 Feb 2019</p>
                            <div class="action-dropdown dropdown">
                        ...
                        <li class="portlet-card">
                            ...
                            <img class="portlet-image w-full" src="{{ asset('vendor/purple-admin-pro/assets/images/samples/300x300/1.jpg') }}" alt="">
                            <div class="badge badge-inverse-warning">important</div>
                            <p class="due-date">Due 10 days</p>
                        </li>
                    </ul>
