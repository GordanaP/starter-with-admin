            ...
            <div class="card chat-app-wrapper">
                <div class="row mx-0">
                        ...
                        <div class="chat-list-item-wrapper">
                            <div class="list-item">
                                <div class="profile-image">
                                    ...
                                    <img class="img-sm rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face1.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="list-item">
                                <div class="profile-image">
                                    <div class="dot-indicator sm bg-primary"></div>
                                    <img class="img-sm rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face2.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="list-item">
                                <div class="profile-image">
                                    ...
                                    <img class="img-sm rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face10.jpg') }}" alt="">
                                </div>
                        ...
                        <div class="chat-container-wrapper">
                            <div class="chat-bubble incoming-chat">
                                ...
                                <div class="sender-details">
                                    <img class="sender-avatar img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face2.jpg') }}" alt="profile image">
                            ...
                            <div class="chat-bubble outgoing-chat">
                                ...
                                <div class="sender-details">
                                    <img class="sender-avatar img-xs rounded-circle" src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face3.jpg') }}" alt="profile image">
                    ...
                    <div class="col-lg-3 d-none d-lg-block px-0 chat-sidebar">
                        <img class="img-fluid w-100" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/profile_image.jpg') }}" alt="profile image">
                        <div class="px-4">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image1.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image2.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image3.jpg') }}" alt="image">
                                </div>
                            </div>
                            <div class="row my-4">
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image4.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image5.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image6.jpg') }}" alt="image">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image7.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image8.jpg') }}" alt="image">
                                </div>
                                <div class="col-4">
                                    <img class="w-100 img-fluid rounded" src="{{ asset('vendor/purple-admin-pro/assets/images/chat/thumb_image4.jpg') }}" alt="image">
                                </div>
