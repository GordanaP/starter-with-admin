...
@section('links')
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/simple-line-icons/css/simple-line-icons.css') }}">
@endsection

@section('content')
    @adminPageHeader(['title' => 'Simple line icons', 'item' => 'Icons'])
    @endadminPageHeader
