                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image12.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image1.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image2.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image3.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image4.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image5.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image6.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image7.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image8.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image9.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image10.jpg') }}" alt="prduct image">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img-outer">
                                        <img class="product_image" src="{{ asset('vendor/purple-admin-pro/assets/images/product_images_2/thumb_image11.jpg') }}" alt="prduct image">
                                    </div>
