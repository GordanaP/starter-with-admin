                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-5 d-lg-flex">
                                    <div class="user-avatar mb-auto">
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face1.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="image-grouped ml-auto">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face20.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Mary Sharp">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face17.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Cory Medina">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face14.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Clyde Hammond">
                    ...
                    <div class="card rounded shadow-none">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6 col-lg-5 d-lg-flex">
                                    <div class="user-avatar mb-auto">
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face2.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                                        <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                                    </div>
                                    <div class="wrapper pl-lg-4">
                                        <div class="wrapper d-flex align-items-center">
                        ...
                        <div class="wrapper border-top">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="image-grouped ml-auto">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face11.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Mary Sharp">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face12.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Cory Medina">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face23.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Clyde Hammond">
                                            <div class="text-avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="4 More Peoples"><span class="d-block pt-2">+4</span></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card rounded shadow-none">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6 col-lg-5 d-lg-flex">
                                    <div class="user-avatar mb-auto">
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face3.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                                        <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                                    </div>
                                    <div class="wrapper pl-lg-4">
                                        <div class="wrapper d-flex align-items-center">
                        ...
                        <div class="wrapper border-top">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="image-grouped ml-auto">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face8.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Mary Sharp">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face7.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Cory Medina">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face9.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Clyde Hammond">
                                            <div class="text-avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="4 More Peoples"><span class="d-block pt-2">+4</span></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card rounded shadow-none">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6 col-lg-5 d-lg-flex">
                                    <div class="user-avatar mb-auto">
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face6.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                                        <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                                    </div>
                                    <div class="wrapper pl-lg-4">
                                        <div class="wrapper d-flex align-items-center">
                        ...
                        <div class="wrapper border-top">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="image-grouped ml-auto">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face13.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Mary Sharp">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face14.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Cory Medina">
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face4.jpg') }}" data-toggle="tooltip" data-placement="top" title="" alt="profile image" data-original-title="Clyde Hammond">
