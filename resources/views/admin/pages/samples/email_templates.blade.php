                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="padding-top: 20px;">
                                  <img style="float:left;width:170px;" src="{{ asset('vendor/purple-admin-pro/assets/images/logo.svg') }}" alt="Logo">
                            ...
                            <tr>
                              <td>
                                <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                                      <img style="display: block;margin: auto;max-width: 8px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/fb.png') }}" alt="facebook">
                                    </td>
                                  </tr>
                                </table>
                                <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                                      <img style="display: block;margin: auto;max-width: 15px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/twitter.png') }}" alt="facebook">
                                    </td>
                                  </tr>
                                </table>
                                <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                                      <img style="display: block;margin: auto;max-width: 15px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/youtube.png') }}" alt="facebook">
                                    </td>
                                  </tr>
                                </table>
                                <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                                      <img style="display: block;margin: auto;max-width: 15px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/medium.png') }}" alt="facebook">
                                    </td>
                                  </tr>
                                </table>
                                <table style="float:left;" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                                      <img style="display: block;margin: auto;max-width: 15px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/slack.png') }}" alt="facebook">
                                    </td>
                                  </tr>
                                </table>
                              </td>
                        ...
                        <td style="padding: 50px;">
                          <table style="width: 550px;margin: 0 auto" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                              ...
                              <tr>
                                <td style="padding-top: 20px;">
                                  <img style="max-width: 100%;width:100%;border-radius: 10px;" src="{{ asset('vendor/purple-admin-pro/assets/images/email/mail-image.jpg') }}" alt="email image">
                                </td>
                              </tr>
                              <tr>
