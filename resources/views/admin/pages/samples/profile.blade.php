...
@section('content')
    @adminPageHeader(['title' => 'Profile', 'item' => 'Sample pages'])
    @endadminPageHeader
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="border-bottom text-center pb-4">
                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face12.jpg') }}" alt="profile" class="img-lg rounded-circle mb-3" />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face13.jpg') }}" alt="profile" class="img-sm rounded-circle" />
                                    <div class="ml-4">
                                        <h6> Mason Beck <small class="ml-4 text-muted">
                                            <i class="mdi mdi-clock mr-1"></i>10 hours</small>
                                        </h6>
                                ...
                                <div class="d-flex align-items-start profile-feed-item">
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face16.jpg') }}" alt="profile" class="img-sm rounded-circle" />
                                        <div class="ml-4">
                                            <h6> Willie Stanley <small class="ml-4 text-muted">
                                                <i class="mdi mdi-clock mr-1"></i>10 hours</small>
                                            </h6>
                                            <img src="{{ asset('vendor/purple-admin-pro/assets/images/samples/1280x768/12.jpg') }}" alt="sample" class="rounded mw-100" />
                                            <p class="small text-muted mt-2 mb-0">
                                                <span>
                                                    <i class="mdi mdi-star mr-1"></i>4
                                                </span>
                                ...
                                <div class="d-flex align-items-start profile-feed-item">
                                    <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face19.jpg') }}" alt="profile" class="img-sm rounded-circle" />
                                    <div class="ml-4">
                                        <h6> Dylan Silva <small class="ml-4 text-muted">
                                            <i class="mdi mdi-clock mr-1"></i>10 hours</small>
                                        </h6>
                                        ...
                                        <img src="{{ asset('vendor/purple-admin-pro/assets/images/samples/1280x768/5.jpg') }}" alt="sample" class="rounded mw-100" />
                                        <p class="small text-muted mt-2 mb-0">
                                            <span>
                                                <i class="mdi mdi-star mr-1"></i>4
                                            </span>
...
@section('scripts')
    ...
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/profile-demo.js') }}"></script>
    @endsection
