                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo">
                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/logo.svg') }}">
                            </div>
                            <h4>New here?</h4>
                            ...
                            <form class="pt-3">
                                ...
                                <div class="mt-3">
                                    <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="{{ asset('vendor/purple-admin-pro/index.html') }}">SIGN UP</a>
                                </div>
