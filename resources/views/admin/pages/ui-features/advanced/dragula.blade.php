...
@section('links')
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/dragula/dragula.min.css') }}">
@endsection

@section('content')
    @adminPageHeader(['title' => 'Dragula', 'item' => 'UI Elements'])
    @endadminPageHeader
                                ...
                                <div id="profile-list-left" class="py-2">
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face1.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face2.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face3.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face4.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                            ...
                            <div class="bg-secondary p-4">
                                ...
                                <div id="profile-list-right" class="py-2">
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face5.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face6.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face7.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
                                    ...
                                    <div class="card rounded mb-2">
                                        <div class="card-body p-3">
                                            <div class="media">
                                                <img src="{{ asset('vendor/purple-admin-pro/assets/images/faces/face8.jpg') }}" alt="image" class="img-sm mr-3 rounded-circle">
                                                <div class="media-body">
...
@section('scripts')
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/dragula/dragula.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/dragula.js') }}"></script>
@endsection