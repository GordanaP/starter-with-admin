            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        ...
                        <button type="button" collapse-7class="btn btn-link btn-fw">Link</button>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-gradient-dark btn-icon-text"> Edit
                            ...
                            <div class="template-demo">
                                ...
                                <button type="button" class="btn btn-gradient-info btn-icon-text"> Print
