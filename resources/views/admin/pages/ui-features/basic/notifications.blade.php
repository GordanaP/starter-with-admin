...
@section('links')
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-toast-plugin/jquery.toast.min.css') }}">
@endsection
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <button type="submit" class="btn btn-success">
                            <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Notify
                        </button>
                    </form>
                </div>
            </div>
...
@section('scripts')
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/jquery-toast-plugin/jquery.toast.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/toastDemo.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/desktop-notification.js') }}"></script>
@endsection