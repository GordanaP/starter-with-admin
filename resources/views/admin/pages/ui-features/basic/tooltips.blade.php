...
@section('content')
    @adminPageHeader(['title' => 'Tooltips', 'item' => 'UI Elements'])
    @endadminPageHeader
...
@section('scripts')
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/tooltips.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/popover.js') }}"></script>
@endsection
