...
@section('content')
    @adminPageHeader(['title' => 'Google maps', 'item' => 'Maps'])
    @endadminPageHeader
...
@section('scripts')
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCnT63XUjqjPgXZ0lFTU_pdpfUX7swzTTM&callback=initMap"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/google-maps.js') }}"></script>
@endsection
