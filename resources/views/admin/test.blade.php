...
@section('links')
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/nouislider/nouislider.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/purple-admin-pro/assets/vendors/ion-rangeslider/css/ion.rangeSlider.css') }}">
@endsection

@section('content')
    @adminPageHeader(['title' => 'Slider', 'item' => 'UI Elements'])
    @endadminPageHeader
...
@section('scripts')
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/nouislider/nouislider.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/vendors/ion-rangeslider/js/ion.rangeSlider.min.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/no-ui-slider.js') }}"></script>
    <script src="{{ asset('vendor/purple-admin-pro/assets/js/ion-range-slider.js') }}"></script>
@endsection
